...
<div markdown="1">
<img src="/images/Kyle-Cranmer-headshot-cropped-square-web.jpeg" width="45%" Alt="Kyle Cranmer" style="float:left; padding-left:15px; padding-right:15px; padding-top:0; padding-bottom:15px" />
...
I also use this website as a playground for web publishing tools such as [Pelican](http://getpelican.com/). Mainly, I'm using it for blogging about my research interests with code and visualizations.
