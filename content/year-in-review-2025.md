...
* **Dancing** my wife and I have been dancing [Forró](https://en.wikipedia.org/wiki/Forró) (a dance from Brazil)
...
* **Houston, January** — I also made a pilgramiage back to Rice University (my alma mater) to give a [distinguished lecture at the Ken Kennedy Institute](https://youtu.be/Vxvf6No8LsE?si=lW7JArW0qa_eEIfH). 
...
* **Heidelberg, September** — Attended the **Heidelberg Laureate Forum**, including [a panel on AI and science](https://www.newsroom.hlf-foundation.org/blog/article/when-ai-can-do-it-all-what-will-be-left-for-human-mathematicians-and-scientists/) ([video](https://youtu.be/I-Ye-rMhRws?si=lEWrqKuPTJ-rMnwL)). A highlight was sharing a short essay called [*The Bittersweet Lesson*]({filename}/the-bittersweet-lesson.md) and getting to chat with Rich Sutton about it.
* **Carnegie Mellon University, October** - It was a moment of pride to give a keynote at [a workshop dedicated to Simulation-Based Inference](https://www.cmu.edu/dietrich/statistics-datascience/stamps/workshop/schedule.html) at CMU's new [STAMPS](https://www.cmu.edu/dietrich/statistics-datascience/stamps/) center.
...
* **Michigan, November** — I was able to visit my colleagues at MIDAS at the University of Michigan and give a talk at their annual [Data and AI Summit](https://midas.umich.edu/events/midas-summit-2025/)
...
* We partnered with **UW Extension** to host events on the promise and risks associated to the use of AI for local governments including the [**Wisconsin Towns Association**](https://www.wisctowns.com/documents/2025-convention-book.pdf), **Wisconsin League of Municipalities**, and [**Wisconsin Counties Association**](https://www.wcaconference.com/_files/ugd/1190ad_5871000c101f4b80b469a67850632b95.pdf).
...
* The **NSF funded our Center for Industrial Research and Community Service (CIRCS) IUCRC** focused on *severe convective storms and insurance industry challenges* — an exciting interdisciplinary effort (see [https://circs.niu.edu/](https://circs.niu.edu/) and [https://iucrc.nsf.gov/](https://iucrc.nsf.gov/)).

---

## 🏆 Honors & Recognition

* **Breakthrough Prize in Fundamental Physics** — for my work connected to the Large Hadron Collider. ([press release](https://www.physics.wisc.edu/2025/04/15/uw-madison-scientists-part-of-team-awarded-breakthrough-prize-in-physics/))
* **Inaugural Pritzker Prize for AI and Science** — this was an immense honor, which recognized my work in [Simulation-based Inference](http://simulation-based-inference.org). ([press release](https://dsi.wisc.edu/2025/11/10/dsi-director-kyle-cranmer-awarded-inaugural-prize-for-ai-in-science/))
...
[1]: https://arxiv.org/search/?query=Cranmer%2C+K&searchtype=author "Search | arXiv e-print repository"
[2]: https://arxiv.org/search/physics?query=Cranmer%2C+K&searchtype=author&utm_source=chatgpt.com "K. Cranmer"
[3]: https://news.wisc.edu/rise-ai-collaboration-hq-to-build-connections-and-advance-research-teaching-and-engagement/?utm_source=chatgpt.com "RISE AI Collaboration HQ to build connections and advance ..."
[4]: https://dsi.wisc.edu/2025/09/22/uw-madison-joins-the-ai-alliance/?utm_source=chatgpt.com "UW–Madison Joins the AI Alliance - Data Science Institute"
[5]: https://dsi.wisc.edu/news/?utm_source=chatgpt.com "News – Data Science Institute – UW–Madison"
