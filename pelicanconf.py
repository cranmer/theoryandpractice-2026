...
DIRECT_TEMPLATES = ['index', 'categories', 'authors', 'archives', 'publications', 'selected-publications', 'presentations', 'collaborators', 'projects', 'projects-draft', 'media', 'search']
